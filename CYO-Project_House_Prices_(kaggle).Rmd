...
dataset$OverallQual <- factor(dataset$OverallQual, levels = c("Poor",
...
The individual basement area variables seem to be redundant, but we observed that having an unfinished basement can be indiciative of a higher "SalePrice" earlier (e.g. relatively large correlation between "BsmtUnfSF" and "SalePrice"). We therefore leave these variables alone.
...
## Summary of Data Analysis and of the Manipulations
