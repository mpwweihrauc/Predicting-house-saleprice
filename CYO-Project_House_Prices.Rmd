...
After training and fitting the model, we will visually inspect which set of hyperparameters achieved the lowest RMSE value as determined by 3-times repeated 10-fold cross-validation. Afterwards we will predict against our `test_set` ("hold-out-set") and determine "out-of-bag" RMSE.
...
tuneGrid <- expand.grid(
  nrounds = seq(200, 5000, 50),
  max_depth = xgb_3rd_tuning$bestTune$max_depth,
  eta = xgb_3rd_tuning$bestTune$eta,
  gamma = 0,
  colsample_bytree = xgb_3rd_tuning$bestTune$colsample_bytree,
  min_child_weight = xgb_3rd_tuning$bestTune$min_child_weight,
  subsample = xgb_3rd_tuning$bestTune$subsample
)
